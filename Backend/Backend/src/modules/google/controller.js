...
class GoogleController {
    ...
    googleCallback = async (req, res) => {
        try {
            ...
            // Render the full onboarding flow (Plans → Payment → Success) inside the popup.
            // After payment, postMessage to the taskpane with google_authed and subscription info.
...
<body>
  ...
  <div id="screenPlans" class="screen active">
    <div class="plans-wrap">
      ...
      <div class="cards">
        ...
        <!-- Starter -->
        <div class="card" id="cardStarter">
          <div class="card-head">
            <span class="card-icon">⚡</span>
            <span class="card-name name-starter">Starter</span>
          </div>
          <div class="price-row">
            <span class="price-curr">₹</span>
            <span class="price-amt" id="starterAmt">499</span>
          ...
          <button class="card-btn btn-starter" onclick="selectPlan('Starter', 499, 399)">Get Started</button>
        </div>
        ...
        <div class="card featured" id="cardPro">
          ...
          <div class="card-head">
            <span class="card-icon">🚀</span>
            <span class="card-name name-pro">Professional</span>
          </div>
          <div class="price-row">
            <span class="price-curr">₹</span>
            <span class="price-amt" id="proAmt">999</span>
            <span class="price-period">/mo</span>
          </div>
          <ul class="feats">
            <li>✓ 5 Companies</li>
            <li>✓ Pull &amp; Push Data</li>
            <li>✓ Data Validation</li>
            <li>✓ Reports</li>
            <li>✓ Priority Support</li>
          </ul>
          <button class="card-btn btn-pro" onclick="selectPlan('Professional', 999, 799)">Get Started</button>
        </div>

        <!-- Enterprise -->
        <div class="card" id="cardEnt">
          <div class="card-head">
            <span class="card-icon">🏢</span>
            <span class="card-name name-ent">Enterprise</span>
          </div>
          <div class="price-row">
          ...
          <button class="card-btn btn-ent" onclick="selectPlan('Enterprise', 0, 0)">Contact Us</button>
        </div>
    ...
    <div class="pay-wrap">
      ...
      <div class="order-card">
        <div class="order-row">
          ...
          <span class="order-val" id="payPlan">Professional</span>
        </div>
        <div class="order-row">
        ...
        <div class="order-row">
          ...
          <span class="order-total-val" id="payTotal">₹999</span>
        </div>
      </div>
  ...
  <div id="screenSuccess" class="screen">
    <div class="success-wrap">
      ...
      <div class="plan-badge-card">
        ...
        <div class="plan-badge-val" id="successPlan">Professional</div>
      </div>
  ...
  <script>
    ...
    var prices = {
      ...
      Professional: { monthly: 999,  yearly: 799 }
    };
    ...
    toggle.addEventListener('change', function() {
      ...
      document.getElementById('starterAmt').textContent = isYearly ? prices.Starter.yearly      : prices.Starter.monthly;
      document.getElementById('proAmt').textContent     = isYearly ? prices.Professional.yearly : prices.Professional.monthly;
    });
    ...
    function selectPlan(plan, monthly, yearly) {
      if (plan === 'Enterprise') {
        alert('Enterprise enquiry noted! Our sales team will contact you at ${email}.');
        return;
      }
      selectedPlan  = plan;
    ...
    /* Send authed message to taskpane and close */
    function finishFlow() {
      var payload = {
        type:           'google_authed',
        email:          '${email}',
...
<html>
  <body style="background:#1a0000;color:#ffaaaa;font-family:sans-serif;text-align:center;padding:40px;">
    ...
    // Returns the currently signed-in Google user info (session-based fallback)
    getMe = async (req, res) => {
